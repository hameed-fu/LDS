...
@section('content')
                ...
                <div class="col-lg-7">
                    <div class="card bg-dark border-0 shadow-lg rounded-4 p-4 text-light">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="badge bg-gradient fs-6 py-2 px-3 shadow"
    ...
    <script>
        ...
        document.getElementById('runBtn').addEventListener('click', () => {
            ...
            const language = selectedLang.toLowerCase(); // ensure lowercase
          ...
          ${language === "tailwind" ? "<scr" + "ipt src='https://cdn.tailwindcss.com'></scr" + "ipt>" : ""}
                ...
                iframe.style =
                    "width:100%;height:400px;border-radius:10px;border:1px solid #334155;background:white;";
            ...
            // Other languages: backend execution
