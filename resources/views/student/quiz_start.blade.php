...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Session: {{ $quiz->session->title }}</p>
        </div>
        ...
        <div class="card shadow border-0 rounded-4 mx-auto" style="max-width: 700px;">
            <div class="card-body p-5 text-center">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('student.course.show', $quiz->session->virtualClass->id) }}" class="btn btn-outline-secondary rounded-pill px-4 py-2">
