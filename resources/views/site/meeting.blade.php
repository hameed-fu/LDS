        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="bg-dark rounded position-relative" style="height: 500px;">
                    ...
                    <div id="remoteVideos"
                        class="h-100 d-flex flex-wrap justify-content-center align-items-center gap-3 p-3"></div>
                    ...
                    <div id="noParticipants"
                        class="text-white text-center h-100 d-flex flex-column justify-content-center align-items-center">
